...
public class ExpressionEvaluator {
    ...
    private static double parseExpression(List<Token> tokens, int[] pos) throws Exception {
    ...
    private static double parseTerm(List<Token> tokens, int[] pos) throws Exception {
    ...
    private static double parseFactor(List<Token> tokens, int[] pos) throws Exception {
